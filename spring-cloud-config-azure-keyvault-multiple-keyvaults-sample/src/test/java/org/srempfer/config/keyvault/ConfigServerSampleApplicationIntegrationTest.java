...
class ConfigServerSampleApplicationIntegrationTest {
    ...
    void verifyPropertySources () throws Exception {
        mockMvc.perform ( get ( "/test-application/default/master" ) )
            ...
            .andExpect ( jsonPath ( "$.propertySources", hasSize ( 3 ) ) )
            ...
            .andExpect ( jsonPath ( "$.propertySources[0].source", allOf (
                ...
                hasEntry ( "client.test.encrypted.one", "decrypted-value-of-keyvault-one" ) )
            ) )
            ...
            .andExpect ( jsonPath ( "$.propertySources[2].name", is ( "keyvault-application-default" ) ) )
            .andExpect ( jsonPath ( "$.propertySources[2].source", hasEntry ( "spring.datasource.password", "test123" ) ) );
    }
}
